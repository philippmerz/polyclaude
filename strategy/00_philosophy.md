...
> - Strategy (2026-05-11 pivot post-R-U miss; refined 2026-05-29 + 2026-05-29 edge-bar relax): mechanical-resolution markets only; **edge bar = positive Kelly recommendation above $5 minimum size (was 10pp; relaxed after operator pointed out R-U was an API-observability failure not an edge-thinness failure)**; `scripts/polyclaude_enter.py` mandatory for every entry; max 5 concurrent positions. **No fixed Aave/PM ratio target — operator removed the 60/40 constraint 2026-05-29; idle capital defaults to Aave (yield + immediate withdrawability), but high-conviction filter-passing PM entries may drain Aave without limit. Discipline lives in: positive-EV filter (Kelly+op-cost), mechanical resolution, cluster cap, max-5 positions, Kelly+ρ sizing, Brownian-bridge late-stage signals, uma_status_check observability — not a static allocation ratio or a phantom edge floor.**

...
## Current state (snapshot 2026-08-26 14:24 UTC)
...
**Total bankroll $190.11; REALIZED +$4.74 (+2.8%) vs the $170 reference** — realized settled cash is the metric that counts (operator directive 2026-08-18: "it's only truly return when the cash settles on the wallet"). Marked unrealized is +$8.13, but executable-depth unrealized is only +$1.69: the 11 PM positions are $173.83 at midpoint versus $167.39 realizable on $165.70 cost, a $6.44 thin-book overstatement. Six maker orders rest. Book: Dec-31 fades (Trump-out NO, Greenland NO), touchscreen-MacBook NO, three HLE leaderboard NO lottery legs, the matched Metamask FDV monotonicity structure (>$700M YES, >$3B/>$4B NO), and two Aug-31 Hormuz contracts. On 2026-08-26, three corridor headlines were processed against first-hand PortWatch data: normal-traffic NO remains supported by a 7-day average of 5 versus the contract's 60 threshold, while 4 NO shares were sold at 0.996 to fund a deliberately minimum-sized $5.03 Iran-Oman-agreement YES ticket (31 shares, 0.1623 average; DEC-0081/0082). The agreement market needs a qualifying bilateral acceptance announcement rather than actual reopening; no adds absent unambiguous Omani acceptance. Entry gates include per-market fees, maker-price evaluation, pessimistic scenario checks, correlation-aware sizing, and criteria rotation. Money-math suite: 86 checks + 10-mutant harness, pre-commit enforced. Short-dated ledger N=51.

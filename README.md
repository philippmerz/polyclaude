...
## Current state (snapshot 2026-09-08 07:49 UTC)
...
**Bankroll:** authoritative total **$191.21 at 07:49:04 UTC**, up $0.14 from the 06:49 snapshot; settled profit **+$14.44 (+8.5%)** versus the $170 reference is unchanged. Gas-token value of $6.25 is excluded from trading P&L. The **07:49:24.400526 UTC** inventory confirms 13 active PM rows costing $157.20. PM midpoint is $157.71, while the fee/depth estimate is $151.81 (the full-precision warning gap rounds to $5.90). That estimate is **not** a synchronized, freshness-verified liquidation quote. Five live maker SELL orders remain, all five with `size_matched=0` at the authenticated 07:48 UTC check (HTTP 200); there are zero BUYs and zero Apple orders. Held quantities match the claim snapshot; no per-position attribution of the latest mark change is asserted.

**Holds and gates:** Gemini ≥50 / debut ≥40 priors remain **0.55 / 0.60**; OpenAI ≥50 / ≥55 **0.35 / 0.40**; Apple **0.65**; Trump-out / Greenland **0.97 / 0.95**. Apple's 07:34 exact-market refresh shows YES/NO marks **0.71/0.29**, versus 0.675/0.325 at 02:00. Its complete-exit estimate is now **$13.14 net**, versus $31.85 raw / $26.95 10pp-stressed hold value, but the book was **105 seconds old**: indicative only, not executable. The bounded source check found no new purchase-date commitment; current product absence and existing late-2026/early-2027 reporting do not prove NO or explain the move. These are separate timestamped measurements; the 07:34 position-level refresh is not synchronized with and does not revise the 07:49 aggregate bankroll above. Duma retains 20 shares in each of three buckets, union fair **0.68**; its add gate fails independently on evidence (**0.68 < 0.75**) and the 02:00 common-min ask (**0.687768 > 0.57**). The 02:00 Duma/MetaMask sequential-book exit estimates were $13.15/$45.16 versus $13.60/$46.80 fair; neither group permits leg-level changes. Those are not new exit quotes. The 10-row named HLE table and both score columns are unchanged in the 06:31 check; its earlier historical control passed. The 07:41 resolution-risk refresh checked 35 unique Gamma markets without alerts, with a valid position fetch. Interpretation/UMA risk, correlated-cluster caps and no-add gates remain in force. See the [backlog](notes/backlog.md) and [latest calibration cohort audit](research/2026-09-08-calibration-cohort-audit.md).
...
**Reminders and balances:** Apple’s official keynote is Sep 9 at 17:00 UTC, with the one-shot review armed for 18:30; AVAV research is scheduled for Sep 9 at 22:00 UTC per the backlog. There is no economic Hormuz exposure beyond **0.003571** dust; Iran–Oman is closed at a $5.03 loss already reflected in settled P&L. The 07:49 balances round to **$2.12 pUSD**, **$16.11 Polygon aUSDC.e**, and **$7.87 Arbitrum aUSDC**. The ledger has 54 records (22 scored forecast rows, 16 matched-baseline rows after the 06:08 exact-identity Kuwait NO grade; neither count represents independent outcomes). First forecasts cover 16 distinct questions, with shared-event dependence still material. No original forecast or price changed. Tests are 640 total / 156 money-math checks, including 38 isolated calibration tests after hardening resolver writes against disk-full truncation. The earlier disk-full ledger truncation was fully recovered, field-verified and journaled at 05:15 UTC. After automatic Git packing, free space is about 533 MiB at 07:48, narrowly above the 512 MiB warning threshold; capacity remains under review. The deployed hourly warning/critical probe and targeted write guard do not substitute for durable headroom or authorized root-owned cleanup.

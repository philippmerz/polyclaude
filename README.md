...
**Last updated:** 2026-09-01 (state snapshot updated every cron tick; this header on structural changes)
...
## Current state (snapshot 2026-09-01 02:10 UTC)
...
**Total bankroll $210.40; REALIZED +$33.27 (+19.6%) vs the $170 reference** — realized settled cash is the metric that counts (operator directive 2026-08-18: "it's only truly return when the cash settles on the wallet"). The 15 PM rows cost $172.04 and mark at $173.16 (+$1.12), but executable-depth value is $164.35 (-$7.69): quote both because thin books overstate the open sleeve by $8.81. No MATERIAL/CRITICAL alert arrived after the prior tick. Oman's official index still has no bilateral acceptance announcement after Aug-25; Iran–Oman remains p_yes=0.04 and HOLD through the Sep-1 03:59 UTC cutoff because $1.24 expected terminal value exceeds the roughly $0.15 executable exit. Six maker sells and zero BUY commitments rest. The HLE board-stasis cluster remains cap-gated with no source change. A newly located independent RASO forecast spans 95–130 United Russia list seats plus 155–210 district seats; the held Duma 295–339 union prior was corrected 0.76→0.68. The set remains HOLD, but its add gate failed on both evidence (<0.75) and price (0.653 asks >0.57). DEC-0107/0108 hold **29 GTA VI ≥20M views NO shares**, $9.81 notional / $10.123515 fee-inclusive. The official counter reached 16.519M at hour 97.06; the latest four-hour pace cooled to 1.37M/day versus 1.178M/day required, while the broader 26-hour pace remains about 1.61M/day. Threshold-straddling fits corrected central/stressed p_no 0.65/0.55→**0.45/0.35**: hold at a 0.285 mark, but no further add. Measure every tick through Sep-4 01:01 UTC. Unused proceeds earn on 16.1021 Polygon aUSDC.e at a 2.91% live hurdle; $6.126490 pUSD remains immediately deployable. Money-math suite: 123 checks plus a 19-case mutation harness, pre-commit enforced. Short-dated ledger N=51.

...
## Current state (snapshot 2026-09-08 01:04 UTC)
...
**Bankroll:** total bankroll **$198.49**; settled profit **+$14.44 (+8.5%)** versus the $170 reference. The $6.23 gas deposits are excluded from trading P&L, not trading capital. The 13 active PM rows cost $157.20; midpoint is $165.02, while the depth/fee estimate is $159.56 (gap $5.46). That estimate is **not** a synchronized, freshness-verified liquidation quote. Five live maker SELL orders remain, all five with `size_matched=0`; there are zero BUYs, zero Apple orders, and no new fills.

**Holds and gates:** Gemini ≥50 / debut ≥40 priors remain **0.55 / 0.60**; OpenAI ≥50 / ≥55 **0.35 / 0.40**; Apple **0.65**; Trump-out / Greenland **0.97 / 0.95**. Duma has 20 shares in each of three buckets, union fair **0.68**; its add gate independently fails because **0.68 < 0.75** and the latest common-min ask **0.687768 > 0.57**. Full-bid exit is $13.15 versus $13.60 fair, and no add remains authorized. MetaMask full-bid exit is $45.12 versus $46.80 fair. The 10-row named HLE table and both score columns are unchanged at 00:31 UTC; its historical control passed. The named HLE source remains subject to interpretation and UMA-resolution risk, not an independent oracle; correlated-cluster caps and no-add gates remain in force. See the [backlog](notes/backlog.md) and [latest calibration cohort audit](research/2026-09-08-calibration-cohort-audit.md) for source and calibration detail.
...
**Reminders and balances:** Apple’s official keynote is Sep 9 at 17:00 UTC, with the one-shot review armed for 18:30; AVAV research is scheduled for Sep 9 at 22:00 UTC per the backlog. There is no economic Hormuz exposure beyond **0.003571** dust; Iran–Oman is closed at a $5.03 loss already reflected in settled P&L. Balances are **2.115500 pUSD**, **~16.11 Polygon aUSDC.e**, and **~7.87 Arbitrum aUSDC**. The current ledger has 54 records (21 scored forecast rows, 18 matched-baseline rows; neither count represents independent outcomes). First forecasts cover 15 distinct questions, with shared-event dependence still material. Tests are 545 total / 156 money-math checks. The test-overwrite incident was fully recovered and journaled at 01:02 UTC.

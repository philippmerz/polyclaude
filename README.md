...
## Current state (snapshot 2026-09-06 02:11 UTC)
...
**Total bankroll $190.09; REALIZED +$14.43 (+8.5%) vs the $170 reference** — realized settled cash is the metric that counts. The **13 active indexed PM rows** cost $157.20 and mark at $156.45 (−$0.74), but executable-depth value is only $149.99 (−$7.20): quote both because thin books overstate the active sleeve by $6.46. Data-api also retains one settled losing Iran–Oman row, excluded from open P&L and advisory tools. Hormuz-normal is de-indexed and still unproposed; its archive holds only **0.003571 dust**, not live economic exposure. Six maker sells and zero BUY commitments rest. Duma remains a 0.68-fair equal-share HOLD with its add gate closed; the Sep-6 daily re-derivation found no newer primary poll or comparable whole-seat forecast. Trump-out and Greenland criteria/source refreshes found no qualifying event or thesis drift; p_no remains **0.97/0.95**. GTA VI finished above 20M views (**21,667,706** on the first post-endpoint read): the combined counter ticket lost **$14.13**, the short-window 92% under-threshold model failed, and this public-counter edge class remains retired. OpenAI launched **GPT-6 Astra** with an official **57.2% HLE-with-tools** result; access currently starts with a limited set of organizations, with broader availability promised over the coming days. agi.safe.ai remains reachable and unchanged, but board-addition/UMA-spirit risk rose. OpenAI ≥50/≥55 p_no fell to **0.35/0.40**; both remain HOLD / NO ADD / NO FLIP because executable exits remain far below stressed hold values. Gemini ≥50 / next-Pro ≥40 remain **0.55/0.60**. MacBook p_no remains 0.65 after a Sep-5 source refresh found no new purchasability evidence ahead of Apple's Sep-9 event. The wallet holds 2.115500 pUSD and about 16.11 Polygon aUSDC.e. All four daemons are singular/current. Money-math suite: 123 checks plus a 19-case mutation harness, pre-commit enforced. Short-dated ledger N=51.

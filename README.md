...
## Current state (snapshot 2026-08-31 18:18 UTC)
...
**Total bankroll $214.52; REALIZED +$33.41 (+19.7%) vs the $170 reference** — realized settled cash is the metric that counts (operator directive 2026-08-18: "it's only truly return when the cash settles on the wallet"). The 15 PM rows cost $167.09 and mark at $172.20 (+$5.11), but executable-depth value is $165.00 (-$2.08): quote both because thin books overstate the open sleeve by $7.20. Oman's official statement index still has no bilateral acceptance announcement. The post-14:00 alert only corroborated the already-processed US–Iran exchange; the Iran–Oman YES prior remains 0.04 and its 31 shares remain HOLD/no-add because $1.24 expected terminal value exceeds the roughly $0.40 executable exit through the Sep-1 03:59 UTC cutoff. Six maker sells and zero BUY commitments rest. The Aug-31 HLE review validated the archive instrument against known 2025 changes, passed Claude/Grok/Gemini coverage, and again found the live agi.safe.ai board identical to 2026-01-15. The next-Gemini-Pro debut NO ticket stays 169 shares, $17.60 notional / $18.22940 fee-inclusive; the correlated `ai-ships-fast-short` cap still blocks additions. Duma still has no independent whole-seat forecast, so its 0.76 union prior and Sep-1..10 add gate remain unchanged. DEC-0107 opened **18 GTA VI ≥20M views NO shares** at 0.27 ($4.86 notional / $5.03739 fee-inclusive) after the official counter reached 15.986M at hour 89.15 and recovered archive points narrowed recent-decay fits to roughly 19.8M–20.4M. Central p_no=0.45 and stressed p_no=0.35 clear the 0.2799 fee-inclusive cost; measure the counter every tick through Sep-4 01:01 UTC. Unused proceeds earn on 21.3512 Polygon aUSDC.e at a 2.96% live hurdle; $5.962610 pUSD remains immediately deployable, inside the $5–10 operational-float band. Money-math suite: 123 checks plus a 19-case mutation harness, pre-commit enforced. Short-dated ledger N=51.
...
Ostium: 0 open perps (SPX / NDX / XAU all TP-closed May-2026; planned OLP deposit parked pre-exploit — zero exposure through both exploit reports, $18M→$24M revised). Crypto sleeve has ~$7.87 aUSDC Aave-Arb plus small stable/gas balances. The PM wallet holds 21.3512 aUSDC.e on Polygon, $5.962610 pUSD operational float, and small raw stable/gas balances after funding DEC-0107. Status scripts read aTokens/pUSD directly, so idle capital is always visible. Run `scripts/crypto_status.py` + `scripts/aave_deposit.py rate` for live figures.

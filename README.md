...
**Total bankroll ~$179, +5.5% vs $170 reference** (bankroll.py; flat since prior tick). 8 PM positions: Dec-31 fade book (Trump-out NO, Greenland NO) + instance entries (SpaceX-IPO YES, touchscreen-MacBook NO, GPT-6-by-Aug-31 NO) + 3 leaderboard NO legs (OpenAI-HLE ≥50/≥55, Gemini-HLE ≥50 — honest fact-based NO priors held against a market pricing loose resolver reads of the frozen agi.safe.ai board; the ≥50 leg is now a $0.68 lottery remnant, max further loss $0.68). GPT-6 NO +27% after the Astra-leak episode fully round-tripped and overshot (YES 0.235→0.56→0.17). FOMC Jul-29: Fed held; the 41sh YES had been maker-exited at 0.26 pre-decision (net +$0.20 wash — the exit doctrine working). **Maker-first execution:** 3 resting post-only take-profit sells at/above fair (GPT-6/MacBook excluded — hidden-info class). New doctrine 2026-07-29: pull ALL resting orders before scheduled binary catalysts. Realized recently: Marvel-SDCC +43.9%, Prime-SDCC +59%, ARB +11.8%, Satoshi + Fed wash exits. Brier ledger N=9: 0.164 vs market 0.203 (beating; N too small for a verdict).

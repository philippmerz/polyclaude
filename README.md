...
## Current state (snapshot 2026-09-01 06:05 UTC)
...
**Total bankroll $208.53; REALIZED +$33.27 (+19.6%) vs the $170 reference** — realized settled cash is the metric that counts. The 15 PM rows cost $172.04 and mark at $171.21 (-$0.83), but executable-depth value is $163.41 (-$8.62): quote both because thin books overstate the open sleeve by $7.79. One MATERIAL alert reported a fresh US–Iran strike exchange; it corroborates the already-known escalation and arrived after the agreement cutoff. Oman's official index still has no bilateral acceptance announcement after Aug-25. Iran–Oman remains p_yes=0.04 and unresolved, while GPT-6 has entered UMA proposal at NO; neither is redeemable yet. Seven maker sells and zero BUY commitments rest. Duma remains a 0.68-fair equal-share HOLD with its add gate failed. DEC-0107/0108 hold **29 GTA VI ≥20M views NO shares**, $9.81 notional / $10.123515 fee-inclusive. The official counter reached 16.676M at hour 101.01; the latest four-hour pace fell to 0.96M/day versus 1.191M/day required and the last eight hours are also below requirement. Central/stressed p_no was cut **0.45/0.35→0.20/0.10**. Taker exit remains below fair, but constrained Kelly wants only about $1 exposure, so DEC-0109 rests a fee-free SELL for 24 shares at 0.20; no fill yet, leaving five if filled. Measure and reprice every tick through Sep-4 01:01 UTC. Unused proceeds earn on 16.1024 Polygon aUSDC.e; $6.126490 pUSD remains deployable. Money-math suite: 123 checks plus a 19-case mutation harness, pre-commit enforced. Short-dated ledger N=51.

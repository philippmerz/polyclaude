...
## Current state (snapshot 2026-08-28 14:00 UTC)
...
**Total bankroll $185.20; REALIZED +$4.87 (+2.9%) vs the $170 reference** — realized settled cash is the metric that counts (operator directive 2026-08-18: "it's only truly return when the cash settles on the wallet"). Marked unrealized is +$3.38, but executable-depth unrealized is -$2.42: the 14 PM rows (12 economic positions) are $168.65 at midpoint versus $162.85 realizable on $165.27 cost, a $5.80 thin-book overstatement. Six maker sells rest. Book: Dec-31 fades (Trump-out NO, Greenland NO), touchscreen-MacBook NO, three HLE leaderboard NO lottery legs, the matched Metamask FDV monotonicity structure (>$700M YES, >$3B/>$4B NO), two Aug-31 Hormuz contracts, and the Sep-20 United Russia 295–339 range. DEC-0083 bought 20 equal YES shares across 295–309 / 310–324 / 325–339 for $11.40 total; the set pays $20 if the official result lands anywhere in the covered range, with central/stressed union probabilities 0.76/0.66 versus 0.57 cost. Never trade one range leg independently. Funding came from selling 12 Hormuz-normal NO at 0.996; 12.1135 remain at p_no 0.998. The Iran-Oman agreement prior remains 0.09 and the existing 31 YES announcement-lottery shares remain a no-add hold because a 0.04 taker exit returns only ~$1.24 versus $2.79 expected. Entry gates now include structured per-market fee schedules, equal-share bundle atomicity, maker-price evaluation, pessimistic scenario checks, correlation-aware sizing, and criteria rotation. Money-math suite: 116 checks plus mutation harness, pre-commit enforced. Short-dated ledger N=51.

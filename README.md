...
## Current state (snapshot 2026-09-02 14:06 UTC)
...
**Total bankroll $207.40; REALIZED +$21.93 (+12.9%) vs the $170 reference** — realized settled cash is the metric that counts. The **14 active indexed PM rows** cost $165.96 and mark at $175.48 (+$9.53), but executable-depth value is $168.90 (+$2.94): quote both because thin books overstate the active sleeve by $6.58. Data-api also retains one settled losing Iran–Oman row, now excluded from open P&L and advisory tools. It finalized NO on Sep-1; DEC-0082's 31 YES shares lost **$5.029998 gross**. `redeem-all` correctly sent no transaction: it requires the held outcome itself to be final at $1, because data-api labels losing rows redeemable too. Hormuz-normal is de-indexed and still unproposed, but DEC-0086 had already sold 12.11 NO; the archive retains only **0.003571 dust**, not a live $12 claim. Six maker sells and zero BUY commitments rest. Duma remains a 0.68-fair equal-share HOLD: Sep-2 complete bids/asks are 0.652/0.683 and the add gate still fails. DEC-0114 holds 12 GTA-under-20M YES shares bought at 0.73 (**$8.878260 gross including fee**). At hour 133 the official count jumped to 18,074,164: the 4h rate exceeds the remaining 1.321M/day requirement, but every 8–16h rate remains below it, so p_yes was cut **0.92→0.82** and the bounded position remains HOLD / NO ADD. The wallet retains 0.854240 pUSD and about 16.10 Polygon aUSDC.e. A fresh Sep-1 macOS/OLED clue supports the touchscreen MacBook pipeline but still says the machine is due by early 2027 and gives no 2026 sale date, so p_no remains 0.65 ahead of the Sep 8–10 event. All four daemons are singular/current. Money-math suite: 123 checks plus a 19-case mutation harness, pre-commit enforced. Short-dated ledger N=51.

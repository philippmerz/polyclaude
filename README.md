...
## Current state (snapshot 2026-09-01 10:05 UTC)
...
**Total bankroll $206.42; REALIZED +$27.07 (+15.9%) vs the $170 reference** — realized settled cash is the metric that counts. The 14 PM rows cost $162.23 and mark at $165.56 (+$3.33), but executable-depth value is $157.06 (-$5.16): quote both because thin books overstate the open sleeve by $8.49. DEC-0110 closed all **29 GTA VI ≥20M views NO shares** at the live 0.13 bid after the official counter reached 16.815M at hour 105.01 and required pace rose to 1.214M/day versus only 0.83M/day over the latest four hours. Net proceeds were $3.606010; total ticket P&L was **−$6.517505** including entry fees. The stale 0.20 maker order was cancelled first. GPT-6 finalized NO and the earlier blended maker exit remains a +$10.02 realized win; Iran-charges-Hormuz-fees finalized NO and the exact skip was graded. Iran–Oman is proposed NO but not final, while Hormuz-normal remains active/unproposed. Six maker sells and zero BUY commitments rest. Duma remains a 0.68-fair equal-share HOLD with its add gate failed. The wallet has 9.732500 deployable pUSD and 16.102584 Polygon aUSDC.e. Redemption fallback now requires a nonzero outcome-token balance before simulation or broadcast after a zero-balance GPT-6 no-op exposed that `eth_call` success alone is insufficient. Money-math suite: 123 checks plus a 19-case mutation harness, pre-commit enforced. Short-dated ledger N=51.

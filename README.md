...
**Passive benchmark:** the same $70/$100 contribution schedule, entered at the first completed trading session strictly after each ledger date, is worth **$180.85 in VT (+6.39%)**, **$181.13 in VTI (+6.55%)**, or **$181.17 in SPY (+6.57%)** at the Sep-9 completed close. The pilot's depth-based trading value trails those comparators by about **$9.33–$9.65**. The reproducible policy and script exclude gas and model ideal fractional shares, reinvested distributions and zero trading/tax friction.

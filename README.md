...
## Current state (snapshot 2026-08-01 02:00 UTC)
...
**Total bankroll $191.23, +12.5% vs $170 reference (new high).** 5 PM positions: Dec-31 fade book (Trump-out NO, Greenland NO) + instance entries (SpaceX-IPO YES, touchscreen-MacBook NO, GPT-6-by-Aug-31 NO 50sh fair 0.88 (naming leak: 5.7-in-Aug)). FOMC Jul-29: Fed held; entire 41sh YES position had been maker-exited at 0.26 pre-decision (net +$0.20 wash on a wrong-at-entry thesis — the exit doctrine working). **Maker-first execution:** 3 resting post-only take-profit sells at/above fair (GPT-6/MacBook excluded — hidden-info class). New doctrine 2026-07-29: pull ALL resting orders before scheduled binary catalysts. Realized recently: Marvel-SDCC +43.9%, Prime-SDCC +59%, ARB +11.8%, Satoshi + Fed wash exits. Brier ledger N=9: 0.164 vs market 0.203 (beating; N too small for a verdict).

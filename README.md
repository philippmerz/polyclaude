...
## Current state (snapshot 2026-09-08 09:57 UTC; separate depth checks 09:59/10:00)
...
**Bankroll:** authoritative total **$187.40 at 09:57:45 UTC**, down $3.82 from 08:49; settled profit **+$14.44 (+8.5%)** versus the $170 reference is unchanged. Gas-token value of $6.28 is excluded from trading P&L. The separate **09:57:47.818011 UTC** inventory confirms 13 active PM rows costing $157.20, with unchanged quantities. PM midpoint is $153.88; indicative fee/depth net is $143.77, a $10.11 gap. A separate 09:59 exact-identity check covers all 13 quantities and sums to **$143.29299845 net**, without empty or insufficient bids, but three books exceed 60 seconds old. Its $6.93 decline versus the retained 08:51 per-leg check is chiefly Apple (-$5.56) and Gemini ≥50 (-$1.42); this is not exact attribution of the separate aggregate bankroll change. Neither all-position estimate is synchronized or freshness-verified executable. Five live maker SELL orders remain, each with `size_matched=0` in the authenticated 09:57 check (HTTP 200); zero BUYs and zero Apple orders. Full evidence: [10:00 depth review](research/2026-09-08-1000-portfolio-depth-check.md).

**Holds and gates:** Gemini ≥50 / debut ≥40 priors remain **0.55 / 0.60**; OpenAI ≥50 / ≥55 **0.35 / 0.40**; Apple **0.65**; Trump-out / Greenland **0.97 / 0.95**. Apple's held-NO Gamma mark fell to **0.175**. Main's separate **10:00:21** exact-token book (.12/.17 touch, age 0.958s) estimates only **$5.25 net** for all 49.005 shares, versus $31.85 raw / $26.95 10pp-stressed hold value. Fresh at observation does not guarantee execution, and those hold values depend on an unproven prior. The bounded source check found no firm new purchase date; the move remains unexplained, not dismissed as noise. No trade/order or prior change. Duma retains 20 shares in each of three buckets, union fair **0.68**; its add gate fails on evidence (**0.68 < 0.75**) and the last 02:00 common-min ask (**0.687768 > 0.57**, not refreshed). The separate 09:59 Duma/MetaMask sequential-book estimates are **$13.18/$44.59** versus $13.60/$46.80 raw fair. MetaMask's rule-based minimum payout is $44.751 before time/resolver risk, not a stop price; its >$4B book was 116.7 seconds old. Group protections remain. The 10-row named HLE table and both score columns were unchanged at **09:57**; its earlier historical control passed. The **09:57** resolution-risk refresh had valid position retrieval and checked 35 unique Gamma markets: one Apple price alert, no finality alert/error. Interpretation/UMA risk, correlated-cluster caps and no-add gates remain in force. See the [backlog](notes/backlog.md) and [latest calibration cohort audit](research/2026-09-08-calibration-cohort-audit.md).

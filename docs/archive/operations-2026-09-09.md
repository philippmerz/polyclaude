# Historical strategy/02_operations.md — before 2026-09-09 consolidation

Status: ARCHIVE / historical evidence. Original text below is preserved verbatim; dates, metrics and technical claims need current verification. Archiving does not revoke the operator mandate. Start at [the knowledge map](../INDEX.md) for the current summaries and later operator updates. Git history retains earlier versions.

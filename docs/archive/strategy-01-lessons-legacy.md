> **ARCHIVE / HISTORY.** This is the verbatim pre-consolidation lessons ledger
> retained for dates and provenance. `strategy/01_lessons.md` is the compact
> summary; consolidation does not revoke the operator mandate. Check dated
> claims and subsequent operator updates before relying on them.

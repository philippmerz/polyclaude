> **ARCHIVE / HISTORY.** This is the verbatim pre-consolidation doctrine
> retained for provenance. `strategy/00_philosophy.md` is the compact summary;
> consolidation does not revoke the operator mandate. Check dated claims and
> subsequent operator updates before relying on them.
